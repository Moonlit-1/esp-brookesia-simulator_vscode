...
class WeatherAppConf: public ESP_Brookesia_PhoneApp {
public:
    static WeatherAppConf &getInstance()
    {
        static WeatherAppConf app;
        return app;
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     *
     */
    WeatherAppConf(bool use_status_bar, bool use_navigation_bar);
